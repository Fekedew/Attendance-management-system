...
public class MyClassActivity extends AppCompatActivity {
    ...
    String selectedStu;
    public static EditText etone, ettwo, etthree, et60, et100;
    Activity activity;
        ...
        addMark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedStu == null)
                    ...
                    String qup = "UPDATE MARK SET out10one='" + one + "', out10two='" + two + "', out10three='" + three + "', " +
                            "out60='" + sixty + "', out100='" + sum + "' WHERE roll='"+stuId+"';";
                    String qu = "INSERT INTO MARK VALUES ( '" + one + "', '" + two + "', '" + three + "', '" + sixty + "', " +
                            "'" + sum + "', '"+stuId+"');";
